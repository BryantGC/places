...
server.post('/getplaces',(req, res) => {
  ...
  axios.get(locationReq).then((response) => {
    ...
    const placesReq = `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${locationData.lat},${locationData.lng}&radius=1500&types=food&name=food&key=AIzaSyCzL86-0uobcrC9pKekXarOSJzqrrg3Igw${PLACES_API_KEY}`;
